...
{
    /// <summary>
    /// Modified version of spline instantiate that doesn't hied generated objects.
    /// </summary>
    [ExecuteInEditMode]
    [AddComponentMenu("Splines/Custom Spline Instantiate")]
    public class CustomSplineInstantiate : SplineComponent
    {
        const string k_InstancesRootName = "root-";
        private string customRootName = null;
